...
const db = createDb({
  ...
  team_members: [
    ...
    { id: 'tm_s2', name: 'Александр', role: 'Винный эксперт', spec: 'Вино, аперитивы и дижестивы', bio: 'Человек, который отвечает в баре за всё, что налито из бутылки с пробкой. Подберёт вино под настроение, а не под этикетку, объяснит, чем вермут отличается от хереса и почему дижестив — лучшая точка в конце вечера. Не знаете, с чего начать винную страницу нашей карты — просто спросите Александра.', quote: 'Вино. Одна из самых цивилизованных вещей на свете.', quote_source: 'Эрнест Хемингуэй, «Смерть после полудня»', photo_url: '/uploads/team/aleksey.jpg', photo_work_url: '/uploads/team/aleksey_work.jpg', sort_order: 1, active: true, created_at: '2026-06-01T12:00:00Z', updated_at: '2026-06-01T12:00:00Z' },
    { id: 'tm_s3', name: 'Владислав', role: 'Бармен', spec: 'Классика и авторские рецептуры', bio: 'Хранитель классики: его Негрони и Олд Фэшн собраны по канону, без самодеятельности. Именно из уважения к классике рождаются его собственные твисты — когда знаешь правила, можно красиво их нарушать. Попросите сделать «как положено» — и поймёте, зачем эти коктейли пережили сто лет.', quote: 'Один мартини в самый раз, два слишком много, а три недостаточно.', quote_source: 'Джеймс Тёрбер', photo_url: '/uploads/team/vladislav.jpg', photo_work_url: '/uploads/team/vladislav_work.jpg', photo_fun_url: '/uploads/team/vladislav_fun.jpg', sort_order: 2, active: true, created_at: '2026-06-01T12:00:00Z', updated_at: '2026-06-01T12:00:00Z' },
    { id: 'tm_s4', name: 'Денис', role: 'Бармен', spec: 'Тропические и фруктовые коктейли', bio: 'Отвечает за солнечную сторону карты: ананас, маракуйя, кокос и всё, что напоминает об отпуске. Верит, что тики-коктейль — это маленький отпуск минут на пятнадцать, и собирает его так, чтобы за окном перестала существовать зима. Если вечер нужно развернуть на сто восемьдесят градусов — вам к Денису.', quote: 'Ничто так не успокаивает дух, как ром и истинная вера.', quote_source: 'Джордж Байрон, «Дон Жуан»', photo_url: '/uploads/team/denis.jpg', photo_work_url: '/uploads/team/denis_work.jpg', sort_order: 3, active: true, created_at: '2026-06-01T12:00:00Z', updated_at: '2026-06-01T12:00:00Z' },
    { id: 'tm_s5', name: 'Дмитрий', role: 'Бармен', spec: 'Авторские рецептуры', bio: 'Экспериментатор бара: пока другие полируют классику, он придумывает то, чего в книгах ещё нет. Настойки, необычные сиропы и сочетания, которые на бумаге выглядят спорно, а в бокале — убедительно. Почти каждый новый пункт в карте авторских — его рук дело.', quote: 'Всё вокруг меняется, это закон жизни.', quote_source: 'Форрест Бондурант, «Самый пьяный округ в мире»', photo_url: '/uploads/team/dmitriy.jpg', photo_work_url: '/uploads/team/dmitriy_work.jpg', photo_fun_url: '/uploads/team/dmitriy_fun.jpg', sort_order: 4, active: true, created_at: '2026-06-01T12:00:00Z', updated_at: '2026-06-01T12:00:00Z' },
    { id: 'tm_s6', name: 'Егор', role: 'Бармен', spec: 'Джин и виски-коктейли', bio: 'Проводник по крепкой части карты: от можжевелового джина до торфяного виски. Любит рассказывать, чем Айла отличается от Спейсайда, но умеет и просто молча налить правильный дрэм. Если вы «не пьёте виски» — дайте ему один шанс вас переубедить.', quote: '«Белая Молния» входит, как нож, острым концом вперёд.', quote_source: 'Джек Бондурант, «Самый пьяный округ в мире»', photo_url: '/uploads/team/egor.jpg', photo_work_url: '/uploads/team/egor_work.jpg', photo_fun_url: '/uploads/team/egor_fun.jpg', sort_order: 5, active: true, created_at: '2026-06-01T12:00:00Z', updated_at: '2026-06-01T12:00:00Z' },
    { id: 'tm_s7', name: 'Леля', role: 'Бармен', spec: '', bio: '', quote: '', quote_source: '', photo_url: '/uploads/team/lelya.jpg', photo_work_url: '/uploads/team/lelya_work.jpg', photo_fun_url: '/uploads/team/lelya_fun.jpg', sort_order: 6, active: true, created_at: '2026-08-27T12:00:00Z', updated_at: '2026-08-27T12:00:00Z' },
  ],
  // События для витрины «Афиши». Здесь только ГРЯДУЩИЕ и намеренно выдуманные —
  // на них проверяется вкладка «Грядущие». Прошедшие события настоящие и
  // заливаются отдельно из канала: node devtools/seed_channel_events.mjs.
  events: [
  ...
  // Упоминания в изданиях. ВНИМАНИЕ: это выдуманные заглушки для локального стенда,
  // названия изданий намеренно несуществующие — настоящие цитаты вносит
  // владелец через админку (вкладка «Издания»), придумывать их нельзя.
  press_mentions: [
