...
// ─── Tab: ИЗДАНИЯ ──────────────────────────────────────────────────────
// Упоминания в изданиях для блока в «Легенде». Цитаты вносятся ТОЛЬКО дословно из
...
function TabPress() {
  ...
  return (
    <div className="adm-tab">
      <p className="adm-tab__desc">
        Выдержки из статей о баре — блок «Упоминания в изданиях» в разделе «Легенда» на сайте. Пока записей нет, блок на сайте не показывается.
      </p>
      <div className="adm-filters">
        <div style={{ flex: 1 }} />
        <button className="adm-btn adm-btn--primary" onClick={() => { setEditing(null); setShowModal(true); }}>
  ...
  return (
    <div className="adm-root">
      ...
      <div className="adm-tabs">
        {[['reservations','БРОНИ'],['tables','СТОЛЫ'],['menu','МЕНЮ'],['events','СОБЫТИЯ'],['reviews','ОТЗЫВЫ'],['press','ИЗДАНИЯ'],['team','КОМАНДА'],['guests','ГОСТИ']].map(([key, label]) => (
          <button key={key}
