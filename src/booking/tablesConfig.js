...
/** ViewBox плана v3 (общий для сайта и PNG в Telegram). Обрезан по столам
 *  (стулья убраны) с небольшими полями — карточка на странице повторяет этот
 *  аспект, поэтому боковых/верт. зазоров внутри рамки нет. */
export const PLAN_VB = { x: 500, y: -200, w: 31300, h: 26600 };
