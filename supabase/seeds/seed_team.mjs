...
const seed = [
  ...
  { name: 'Денис', role: 'Бармен', spec: 'Миксология и авторские настойки',
    quote: '«Настоящий вкус нельзя поторопить, его можно только настоять»', photoUrl: '/uploads/team/denis.jpg' },
  { name: 'Дмитрий', role: 'Бармен', spec: 'Фристайл-коктейли и твисты',
